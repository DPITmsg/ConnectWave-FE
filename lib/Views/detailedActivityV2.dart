...
class detailed_activity_pagev2 extends StatefulWidget {
  ActivityDetails activity;
  final User user;
  late final bool quickJoin;
  bool _isOnline;
  final void Function(int id) updateCallback;

  detailed_activity_pagev2(
      this.activity, this.user, this._isOnline, this.quickJoin, this.updateCallback,
      {super.key});

  @override
  State<detailed_activity_pagev2> createState() => _detailed_activity_pageStatev2();
}

class _detailed_activity_pageStatev2 extends State<detailed_activity_pagev2> {
  bool isFriend = false;
  bool isAuthor = false;
  bool didJoin = false;
  ...
  void _onBackPressed() {
    ...
    widget.updateCallback(widget.activity.id);
